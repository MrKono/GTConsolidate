...
public class MetaTileEntityCoAAdvanced extends GCYMRecipeMapMultiblockController {

    private int workTier;

    public MetaTileEntityCoAAdvanced(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTConsolidateRecipeMaps.COA_RECIPES);
        this.recipeMapWorkable = new CoAAdvancedRecipeLogic(this);
    }

    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity mte) {
        return new MetaTileEntityCoAAdvanced(metaTileEntityId);
    }
    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('B', states(GTConsolidateMetaBlocks.PARALLELIZED_ASSEMBLY_LINE_CASING.getState(
                        BlockParallelizedAssemblyLineCasing.ParallelizedAssemblyLineCasingType.CASING)))
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .where('B',
                        GTConsolidateMetaBlocks.PARALLELIZED_ASSEMBLY_LINE_CASING.getState(
                                BlockParallelizedAssemblyLineCasing.ParallelizedAssemblyLineCasingType.CASING))
                .where('C', MetaBlocks.CLEANROOM_CASING.getState(BlockCleanroomCasing.CasingType.FILTER_CASING))
                .where('E', MetaTileEntities.LASER_INPUT_HATCH_256[3], EnumFacing.UP)
                ...
                .where('P',
                        MetaBlocks.BOILER_CASING
                                .getState(BlockBoilerCasing.BoilerCasingType.POLYTETRAFLUOROETHYLENE_PIPE))
                .where('S', GTConsolidateMetaTileEntity.COA_ADVANCED, EnumFacing.SOUTH)
    ...
    protected void initializeAbilities() {
        ...
        List<IEnergyContainer> inputEnergy = new ArrayList<>(getAbilities(MultiblockAbility.INPUT_LASER));
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @NotNull List<String> tooltip,
        ...
        tooltip.add(I18n.format("gtconsolidate.multiblock.tooltip.universal.limit.energy_in.laser"));
    }

    private class CoAAdvancedRecipeLogic extends GCYMMultiblockRecipeLogic {

        public CoAAdvancedRecipeLogic(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
        }
